...
WebAppStrategy.prototype.authenticate = function (req, options = {}) {
	...
	} else if (req.query && req.query.appsso, this) {
		// Handle grant code in callback
		return handleAppSsoCallback(req, options, this);
	...
	} else if (req.query && req.query.sso) {
		//Handle sso request
		return handleAppSsoAuthorization(req, options, this);
	} else {
...
function handleAppSsoAuthorization(req, options = {}, strategy) {
	logger.debug("handleAppAuthorization");
	...
	redirectForAppSsoAuthorization(req, options, strategy);
}
...
function redirectForAppSsoAuthorization(req, options, strategy) {
	...
	var authUrl = generateAppSsoAuthorizationUrl(options, req, strategy);
...
function generateAppSsoAuthorizationUrl(options, req, strategy) {
