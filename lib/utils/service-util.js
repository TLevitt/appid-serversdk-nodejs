 ...
 * @property {function():string} getAppSsoServerUrl - returns the server url
...
function loadConfig(configName, requiredParams, options={}) {
	...
	serviceConfig[constants.APP_SSO_URL] = findParam(constants.APP_SSO_URL);
	...
	const getAppSsoServerUrl = () => removeTrailingSlash(serviceConfig[constants.APP_SSO_URL]);
